...
// Charger HEADER puis FOOTER puis lancer le reste du site
Promise.all([
...
.then(([headerData, footerData]) => {
  ...
  // Maintenant que le header est présent, on peut initialiser le site :
  initSiteScripts();
})
...
// -----------------------------------------------------------
//   FONCTION PRINCIPALE (tout ton JS ici)
// -----------------------------------------------------------
